...
MODEL_DIR=$TACO_DIR"/model/warmup_nce_mt/mt_msmarco/"
DATA_DIR=$TACO_DIR"/data/"
#RAW_DIR=$DATA_DIR"/raw/"
#PROCESSED_DIR=$DATA_DIR"/processed/bm25/"
LOG_DIR=$TACO_DIR"/logs/warmup_nce_mt/mt_msmarco/"
EMBEDDING_DIR=$TACO_DIR"/embeddings/warmup_nce_mt/mt_msmarco/"
RESULT_DIR=$TACO_DIR"/results/warmup_nce_mt/mt_msmarco/"
EVAL_DIR=$TACO_DIR"/metrics/trec/trec_eval-9.0.7/trec_eval-9.0.7/"
ANCE_PROCESSED_DIR=$DATA_DIR"ance_mt/mt_msmarco/processed/"
ANCE_MODEL_DIR=$TACO_DIR"/model/hard_nce_mt/mt_msmarco/"
mkdir -p $TACO_DIR
mkdir -p $PLM_DIR
mkdir -p $MODEL_DIR
mkdir -p $DATA_DIR
