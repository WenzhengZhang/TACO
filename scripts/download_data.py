# adapted from https://github.com/facebookresearch/DPR/blob/main/dpr/data/download_data.py
# scripts for downloading open-qa datasets and kilt datasets
import argparse
import gzip
import logging
import os
...
RESOURCES_MAP = {
    ...
    "data.kilt_wikipedia_split.psgs_w100": {
        "s3_url": "https://dl.fbaipublicfiles.com/ur/wikipedia_split/psgs_w100.tsv.gz",
        "original_ext": ".tsv",
        "compressed": True,
        "desc": "Entire wikipedia passages set obtain by splitting all pages into 100-word segments (no overlap)",
    },
    "data.retriever.kilt-wow-train": {
            "s3_url": "https://dl.fbaipublicfiles.com/ur/data/retriever/wow-train-multikilt.json.gz",
            "original_ext": ".json",
            "compressed": True,
            "desc": "Kilt wow train data",
        },
    "data.retriever.kilt-wow-dev": {
                "s3_url": "https://dl.fbaipublicfiles.com/ur/data/retriever/wow-dev-multikilt.json.gz",
                "original_ext": ".json",
                "compressed": True,
                "desc": "Kilt wow dev data",
            },
    "data.retriever.kilt-trex-train": {
                    "s3_url": "https://dl.fbaipublicfiles.com/ur/data/retriever/trex-train-multikilt.json.gz",
                    "original_ext": ".json",
                    "compressed": True,
                    "desc": "Kilt trex train data",
                },
    "data.retriever.kilt-trex-dev": {
                        "s3_url": "https://dl.fbaipublicfiles.com/ur/data/retriever/trex-dev-multikilt.json.gz",
                        "original_ext": ".json",
                        "compressed": True,
                        "desc": "Kilt trex dev data",
                    },

    "data.retriever.kilt-aida-train": {
                            "s3_url": "https://dl.fbaipublicfiles.com/ur/data/retriever/aidayago2-train-multikilt.json.gz",
                            "original_ext": ".json",
                            "compressed": True,
                            "desc": "Kilt aida train data",
                        },
    "data.retriever.kilt-aida-dev": {
                                "s3_url": "https://dl.fbaipublicfiles.com/ur/data/retriever/aidayago2-dev-multikilt.json.gz",
                                "original_ext": ".json",
                                "compressed": True,
                                "desc": "Kilt aida dev data",
                            },
    "data.retriever.kilt-fever-train": {
                                    "s3_url": "https://dl.fbaipublicfiles.com/ur/data/retriever/fever-train-multikilt.json.gz",
                                    "original_ext": ".json",
                                    "compressed": True,
                                    "desc": "Kilt Fever train data",
                                },
    "data.retriever.kilt-fever-dev": {
                                        "s3_url": "https://dl.fbaipublicfiles.com/ur/data/retriever/fever-dev-multikilt.json.gz",
                                        "original_ext": ".json",
                                        "compressed": True,
                                        "desc": "Kilt Fever dev data",
                                    },
    "data.retriever.kilt-hopo-train": {
                                        "s3_url": "https://dl.fbaipublicfiles.com/ur/data/retriever/hotpotqa-train-multikilt.json.gz",
                                        "original_ext": ".json",
                                        "compressed": True,
                                        "desc": "Kilt HotpotQA train data",
                                        },
    "data.retriever.kilt-hopo-dev": {
                                "s3_url": "https://dl.fbaipublicfiles.com/ur/data/retriever/hotpotqa-dev-multikilt.json.gz",
                                "original_ext": ".json",
                                "compressed": True,
    ...
    "data.retriever.kilt-nq-train": {
                                "s3_url": "https://dl.fbaipublicfiles.com/ur/data/retriever/nq-train-multikilt.json.gz",
                                "original_ext": ".json",
                                "compressed": True,
                                "desc": "Kilt NQ train data",
                                            },
    "data.retriever.kilt-nq-dev": {
                                "s3_url": "https://dl.fbaipublicfiles.com/ur/data/retriever/nq-dev-multikilt.json.gz",
                                "original_ext": ".json",
                                "compressed": True,
                                "desc": "Kilt NQ dev data",
                                            },
    "data.retriever.kilt-zeroshot-train": {
                                    "s3_url": "https://dl.fbaipublicfiles.com/ur/data/retriever/zeroshot-train-multikilt.json.gz",
                                    "original_ext": ".json",
                                    "compressed": True,
                                    "desc": "Kilt zeroshot train data",
                                                },
    "data.retriever.kilt-zeroshot-dev": {
                                        "s3_url": "https://dl.fbaipublicfiles.com/ur/data/retriever/zeroshot-dev-multikilt.json.gz",
                                        "original_ext": ".json",
                                        "compressed": True,
                                        "desc": "Kilt zeroshot train data",
                                                    },
