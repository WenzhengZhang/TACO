...
do
  ...
  do
    ...
    max_p_len=160
    n_passage=3
    mt_train_paths+="$delimiter"$DATA_DIR/${kilt_set}/processed/ance_hn_mt/${mt_method}/hn_iter_${hn_iter}/train.jsonl
    mt_eval_paths+="$delimiter"$DATA_DIR/${kilt_set}/processed/ance_hn_mt/${mt_method}/hn_iter_${hn_iter}/val.jsonl
  ...
  do
    ...
    if [ $hn_iter != 0 ]; then
      ...
      mkdir -p $DATA_DIR/${kilt_set}/processed/ance_hn_mt/${mt_method}/hn_iter_${hn_iter}
      python src/taco/dataset/build_hn.py  \
          ...
          --save_to $DATA_DIR/${kilt_set}/processed/ance_hn_mt/${mt_method}/hn_iter_${hn_iter} \
      ...
      tail -n 500 $DATA_DIR/${kilt_set}/processed/ance_hn_mt/${mt_method}/hn_iter_${hn_iter}/train_all.jsonl > $DATA_DIR/${kilt_set}/processed/ance_hn_mt/${mt_method}/hn_iter_${hn_iter}/val.jsonl
      head -n -500 $DATA_DIR/${kilt_set}/processed/ance_hn_mt/${mt_method}/hn_iter_${hn_iter}/train_all.jsonl > $DATA_DIR/${kilt_set}/processed/ance_hn_mt/${mt_method}/hn_iter_${hn_iter}/train.jsonl
      rm $DATA_DIR/${kilt_set}/processed/ance_hn_mt/${mt_method}/hn_iter_${hn_iter}/train_all.jsonl
    fi
  done
