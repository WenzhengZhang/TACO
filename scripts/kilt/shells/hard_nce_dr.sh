...
do
  ...
  do
      ...
      if [ $hn_iter != 0 ]; then
        ...
        mkdir -p $DATA_DIR/${kilt_set}/processsed/hard_nce_dr/hn_iter_${hn_iter}
        python src/taco/dataset/build_hn.py  \
            ...
            --save_to $DATA_DIR/${kilt_set}/processsed/hard_nce_dr/hn_iter_${hn_iter} \
        ...
        tail -n 500 $DATA_DIR/${kilt_set}/processsed/hard_nce_dr/hn_iter_${hn_iter}/train_all.jsonl > $DATA_DIR/${kilt_set}/processsed/hard_nce_dr/hn_iter_${hn_iter}/val.jsonl
        head -n -500 $DATA_DIR/${kilt_set}/processsed/hard_nce_dr/hn_iter_${hn_iter}/train_all.jsonl > $DATA_DIR/${kilt_set}/processsed/hard_nce_dr/hn_iter_${hn_iter}/train.jsonl
        rm $DATA_DIR/${kilt_set}/processsed/hard_nce_dr/hn_iter_${hn_iter}/train_all.jsonl
      fi
      ...
      torchrun --nproc_per_node=$n_gpu --standalone --nnodes=1 src/taco/driver/train_dr.py \
          ...
          --train_path $DATA_DIR/${kilt_set}/processsed/hard_nce_dr/hn_iter_${hn_iter}/train.jsonl  \
          --eval_path $DATA_DIR/${kilt_set}/processsed/hard_nce_dr/hn_iter_${hn_iter}/val.jsonl \
          --fp16  \
